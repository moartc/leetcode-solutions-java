...
class SolutionTest {
    ...
    void buildTreeTest1() {
        ...
        Assertions.assertThat(answer.val).isEqualTo(3);
        Assertions.assertThat(answer.left.val).isEqualTo(9);
        Assertions.assertThat(answer.left.left).isNull();
        Assertions.assertThat(answer.left.right).isNull();

        Assertions.assertThat(answer.right.val).isEqualTo(20);
        Assertions.assertThat(answer.right.left.val).isEqualTo(15);
        Assertions.assertThat(answer.right.left.left).isNull();
        Assertions.assertThat(answer.right.left.right).isNull();

        Assertions.assertThat(answer.right.right.val).isEqualTo(7);
        Assertions.assertThat(answer.right.right.left).isNull();
        Assertions.assertThat(answer.right.right.right).isNull();
    }
    ...
    void buildTreeTest3() {
        ...
        int[] preorder = new int[]{1, 2, 4, 8, 9, 5, 3, 6, 7, 10};
        int[] inorder = new int[]{8, 4, 9, 2, 5, 1, 6, 3, 10, 7};

        TreeNode answer = solution.buildTree(preorder, inorder);
        Assertions.assertThat(answer.val).isEqualTo(1);
        Assertions.assertThat(answer.left.val).isEqualTo(2);
        Assertions.assertThat(answer.right.val).isEqualTo(3);
        Assertions.assertThat(answer.left.left.val).isEqualTo(4);
        Assertions.assertThat(answer.left.right.val).isEqualTo(5);
        Assertions.assertThat(answer.right.left.val).isEqualTo(6);
        Assertions.assertThat(answer.right.right.val).isEqualTo(7);
        Assertions.assertThat(answer.left.left.left.val).isEqualTo(8);
        Assertions.assertThat(answer.left.left.right.val).isEqualTo(9);
        Assertions.assertThat(answer.right.right.left.val).isEqualTo(10);
    }
